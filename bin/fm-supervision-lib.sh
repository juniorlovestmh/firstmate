...
#   FM_SUP_NEEDED         true/false - in-flight work or a home-level poll
...
# Exit 0 (true) exactly when in-flight work or a home-level poll needs a watcher.
# Exit 1 (false) for an idle home.
