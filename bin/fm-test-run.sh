...
family_for_basename() {
  case "$1" in
    ...
    fm-herdr-lab.test.sh|fm-kimi-harness.test.sh|fm-lint.test.sh|fm-secrets-check.test.sh|\
    ...
    fm-send-secondmate-marker.test.sh|fm-shared-captain-inheritance.test.sh)
      printf '%s\n' secondmate
      ;;
    fm-bootstrap.test.sh|fm-fleet-sync.test.sh|fm-gate-refuse.test.sh|fm-gotmp.test.sh|fm-muster.test.sh|\
    ...
    fm-herdr-session-cleanup.test.sh|fm-send-strict.test.sh|fm-spawn-backlog-warning.test.sh|fm-spawn-batch.test.sh|\
...
families_for_changed_path() {
  ...
  case "$path" in
    ...
    bin/fm-install-herdr.sh|bin/fm-install-treehouse.sh|bin/fm-herdr-ci-cleanup.sh)
      ...
      printf '%s\n' real-herdr-gated
      ;;
    bin/fm-lint.sh|bin/fm-install-shellcheck.sh|bin/fm-secrets-check.sh|bin/fm-secrets-check.mjs|\
