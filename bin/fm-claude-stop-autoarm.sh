...
#   - Need: arms only while work is in flight (state/*.meta) or a home-level
#     X-mode or Better Stack poll is active; an idle home exits 0.
...
# --- need: in-flight work or a home-level poll -------------------------------
need_supervision() {
