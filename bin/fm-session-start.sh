...
#                       secondmate liveness, X-mode artifact writes, Better Stack
#                       incident-poll registration, fleet sync)
...
# secondmate homes, writing X-mode and Better Stack poll artifacts,
# fetching/fast-forwarding every
