...
`bin/fm-supervision-lib.sh` also recognizes X-mode and Better Stack home-level polls as supervision needs, but unaccounted primary work still contributes nothing to that predicate.
