...
4. Ordinary wake: re-arm the next cycle with the same background `bin/fm-watch-arm.sh` call if work remains in flight or a home-level X-mode, Better Stack, or Woodpecker poll remains active.
