...
This skill and its referenced files are the sole full-doctrine owner for Firstmate.
...
- **Doctrine travels in the prompt.** Paste the canonical
  [credit-rules module](assets/credit-rules.md) into any subagent dispatch
