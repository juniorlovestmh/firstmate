...
Every generated Firstmate ship, scout, and secondmate instruction also carries the canonical credit-rules module from this skill; the scaffold refuses to generate an instruction when that module is missing or empty.
