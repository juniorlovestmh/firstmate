...
- `project-management` - load before adding, creating, removing, or initializing a project.
 - `project-management` - load before adding, creating, removing, initializing, cloning, or registering a project; cloning or registering is add intake and uses the same trigger.
